...
import { getProductById } from "@/services/mockProductAdapter";
...
export default async function ProductDetailPage({
  ...
  return (
    <div className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <Link
        href="/"
        className="mb-8 inline-flex items-center gap-1.5 text-sm font-medium text-foreground-muted transition-colors hover:text-foreground"
      >
        <ArrowLeft className="h-4 w-4" aria-hidden="true" />
        Back to results
      </Link>
      ...
      <div className="mb-8 flex flex-col gap-8 lg:flex-row">
        ...
        <div className="flex flex-col justify-center gap-5 lg:w-3/5">
          ...
          <div>
            <span className="text-caption text-foreground-subtle">{product.category}</span>
